...
```{r UWW-NRWST-DIST, out.width = "100%", fig.cap = "Study area for the Upper Walla Walla watershed habitat capacity assessment. Primary rivers and tributaries utilized by Chinook salmon and steelhead are labeled in the map."}
...
-   Reference Josh's fish status assessment
