...
reqs = tibble(Sim_number = rep(1:n.sim,2),
              ...
              egg_to_parr = c(runif(n.sim, params$Value[4]-params$SD[4], params$Value[4]+params$SD[4]),
                          runif(n.sim, params$Value[9]-params$SD[9], params$Value[9]+params$SD[9])),
              parr_to_presmolt = c(runif(n.sim, params$Value[5]-params$SD[5], params$Value[5]+params$SD[5]),
                          runif(n.sim, params$Value[10]-params$SD[10], params$Value[10]+params$SD[10]))) %>%
  mutate(Female_escapement = Escapement * f_ratio,
         Redds = Female_escapement * redds_f,
         Eggs = Redds * fecund,
         Summer_juv = Eggs * egg_to_parr,
