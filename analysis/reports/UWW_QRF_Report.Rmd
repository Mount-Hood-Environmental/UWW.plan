...
Estimates of total capacity by species and life-stage are shown in Table \@ref(tab:cap-table). Currently, using the spatial domains defined in [StreamNet](https://www.streamnet.org/home/data-maps/gis-data-sets/), capacity extrapolations were made for `r unique(cap_totals$n_rchs[cap_totals$Species == "Chinook"])` reaches totaling `r round(unique(cap_totals$tot_length[cap_totals$Species == "Chinook"]) / 1000)` km in length for Chinook salmon and `r prettyNum(unique(cap_totals$n_rchs[cap_totals$Species == "Steelhead"]), big.mark = ",")` reaches totaling `r round(unique(cap_totals$tot_length[cap_totals$Species == "Steelhead"]) / 1000)` km in length for steelhead. If different spatial domains are deemed more appropriate these modeled spatial domains can be updated, taking into account study questions.
...
Maps of the capacity extrapolations are shown in Figures \@ref(fig:chnk-maps) and \@ref(fig:sthd-maps).
...
chnk_sum_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile Chinook salmon, summer rearing** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
...
chnk_win_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile Chinook salmon, winter rearing** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
...
chnk_redd_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile Chinook salmon, spawning (redds)** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
...
sthd_sum_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile steelhead, summer rearing** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
...
sthd_win_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile steelhead, winter rearing** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
...
sthd_redd_cap %>%
  ...
  kable(booktabs = T,
        ...
        align = "lcccc",
        format.args = list(big.mark = ","),
        caption = "Estimates of currently available habitat for **juvenile steelhead, spawning (redds)** in the Upper Walla Walla watershed.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
