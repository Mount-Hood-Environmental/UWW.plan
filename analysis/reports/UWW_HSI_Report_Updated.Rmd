...
chnk_curves_df <- data.frame (x_values,
...
chnk_curves <- tidyr::gather(chnk_curves_df, key = "curve", value = "y_value", -x_values)
...
sthd_curves_df <-  data.frame (x_values,
...
sthd_curves <- tidyr::gather(sthd_curves_df, key = "curve", value = "y_value", -x_values)
sthd_curves$curve <- factor(sthd_curves$curve, levels = 
 c( "Steelhead.Winter.Juvenile.Depth", "Steelhead.Summer.Juvenile.Depth",      "Steelhead.Spawning.Depth",     "Steelhead.Winter.Juvenile.Velocity",
"Steelhead.Summer.Juvenile.Velocity",  "Steelhead.Spawning.Velocity"))
# Plot the function using ggplot2
