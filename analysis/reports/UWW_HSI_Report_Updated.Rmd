...
#Set x values to plug into function
...
chnk_curves_df <- data.frame (x_values,
                             ...
                             `Chinook Summer Spawning Depth`    = chnk_spw_d(x_values),
                             `Chinook Summer Spawning Velocity` = chnk_spw_v(x_values))
chnk_curves <- tidyr::gather(chnk_curves_df, key = "curve", value = "y_value", -x_values)
chnk_curves$curve <- factor(chnk_curves$curve, levels = c( "Chinook.Winter.Juvenile.Depth",    "Chinook.Summer.Juvenile.Depth",    "Chinook.Summer.Spawning.Depth",
                                                           "Chinook.Winter.Juvenile.Velocity", "Chinook.Summer.Juvenile.Velocity", "Chinook.Summer.Spawning.Velocity"))
...
sthd_curves_df <-  data.frame (x_values,
       ...
       `Steelhead Spring Spawning Depth`    = sthd_spw_d(x_values),
       `Steelhead Spring Spawning Velocity` = sthd_spw_v(x_values))
...
sthd_curves$curve <- factor(sthd_curves$curve, levels = 
 c( "Steelhead.Winter.Juvenile.Depth", "Steelhead.Summer.Juvenile.Depth",      "Steelhead.Spring.Spawning.Depth",     "Steelhead.Winter.Juvenile.Velocity",
"Steelhead.Summer.Juvenile.Velocity",  "Steelhead.Spring.Spawning.Velocity"))
# Plot the function using ggplot2
