...
chnk_curves_df <- tibble (x_values,
                          `Chinook Winter Juvenile Depth`    = chnk_win_d(x_values),
                          `Chinook Winter Juvenile Velocity` = chnk_win_v(x_values),
                          `Chinook Summer Juvenile Depth`    = chnk_juv_d(x_values),
                          `Chinook Summer Juvenile Velocity` = chnk_juv_v(x_values),
                          `Chinook Spawning Depth`    = chnk_spw_d(x_values),
                          `Chinook Spawning Velocity` = chnk_spw_v(x_values))
chnk_curves <- tidyr::gather(chnk_curves_df, key = "curve", value = "y_value", -x_values, convert = TRUE)
chnk_curves$curve <- factor(chnk_curves$curve, levels = c( "Chinook Winter Juvenile Depth",    "Chinook Summer Juvenile Depth",    "Chinook Spawning Depth",
                                                           "Chinook Winter Juvenile Velocity", "Chinook Summer Juvenile Velocity", "Chinook Spawning Velocity"))
...
sthd_curves_df <-  tibble (x_values,
       `Steelhead Winter Juvenile Depth`    = sthd_win_d(x_values),
       `Steelhead Winter Juvenile Velocity` = sthd_win_v(x_values),
       `Steelhead Summer Juvenile Depth`    = sthd_juv_d(x_values),
       `Steelhead Summer Juvenile Velocity` = sthd_juv_v(x_values),
       `Steelhead Spawning Depth`    = sthd_spw_d(x_values),
       `Steelhead Spawning Velocity` = sthd_spw_v(x_values))

sthd_curves <- tidyr::gather(sthd_curves_df, key = "curve", value = "y_value", -x_values, convert = TRUE)

sthd_curves$curve <- factor(sthd_curves$curve, levels =  c( "Steelhead Winter Juvenile Depth",    "Steelhead Summer Juvenile Depth",      "Steelhead Spawning Depth",                                                                            "Steelhead Winter Juvenile Velocity", "Steelhead Summer Juvenile Velocity",   "Steelhead Spawning Velocity"))
# Plot the function using ggplot2
...
```{r chnk-win-box-p, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Chinook salmon juvenile winter rearing** across geomorphic reaches in the Upper Walla Walla watershed, 2019 and 2021."}
...
```{r sthd-spw-box-p, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Steelhead spawning** across geomorphic reaches in the Upper Walla Walla watershed, 2019 and 2021."}
...
```{r sthd-win-box-p, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead juvenile winter rearing** across geomorphic reaches in the Upper Walla Walla watershed, 2019 and 2021."}
...
```{r chnk-win-box-rkm-ms, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Chinook salmon juvenile Winter rearing** across river kilometers in the **mainstem** Upper Walla Walla River, 2021."}
...
```{r chnk-win-box-rkm-nf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Chinook salmon juvenile winter rearing** across river kilometers in the **North Fork** Walla Walla River, 2021."}
...
```{r chnk-win-box-rkm-sf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Chinook salmon juvenile winter rearing** across river kilometers in the **South Fork** Walla Walla River, 2021."}
...
```{r sthd-spw-box-rkm-ms, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead spawning** across river kilometers in the **mainstem** Upper Walla Walla River, 2021."}
...
```{r sthd-spw-box-rkm-nf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **Steelhead Spawning** across river kilometers in the **North Fork** Walla Walla River, 2021."}
...
```{r sthd-spw-box-rkm-sf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead spawning** across river kilometers in the **South Fork** Walla Walla River, 2021."}
...
```{r sthd-win-box-rkm-ms, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead juvenile winter rearing** across river kilometers in the **mainstem** Upper Walla Walla River, 2021."}
...
```{r sthd-win-box-rkm-nf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead juvenile winter rearing** across river kilometers in the **North Fork** Walla Walla River, 2021."}
...
```{r sthd-win-box-rkm-sf, fig.cap = "Box plots showing the distribution of suitability values for composite, depth and velocity for **steelhead juvenile winter rearing** across river kilometers in the **South Fork** Walla Walla River, 2021."}
