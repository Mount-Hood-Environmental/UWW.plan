...
The summer stream temperature assessment focused on the upper Walla Walla River from the confluence with Dry Creek near Lowden, Washington, to the headwaters of the North Fork and South Fork of the Walla Walla River, including tributaries (Table \@ref(tab:study-area)). Temperate predictions for rivers and tributaries used the assessment were pulled from the NorWeST regional database [@Isaak2017a].
...
```{r norwest-bp, out.width = "70%", fig.cap = "Boxplots showing distributions of average August stream temperatures of river and tributary reaches under modeled stream temperature scenarios in the Upper Walla Walla watershed."}
