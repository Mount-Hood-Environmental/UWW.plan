...
temp_suit_tab = norwest_df %>%
  ...
  kable(booktabs = T,
        align = "cccccc",
        caption = "The percentage of stream length that falls within optimum, above optimum, above maximum, and above acute temperature thresholds for each species, life stage combination and under recent mean and projected summer stream temperature scenarios.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
temp_suit_tab   
