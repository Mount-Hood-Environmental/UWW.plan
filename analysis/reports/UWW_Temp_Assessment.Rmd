...
In general, a larger percentage of stream length within the Upper Walla 
...
temp_suit_tab = uww_rch_sf %>%
  ...
  arrange(match(`Life Stage`, c("Chinook Spawning", 
                                ...
                                "Bull Trout", 
                                "Pacific Lamprey"))) %>%
  mutate(`Above Acute` = replace_na(`Above Acute`, 0)) %>%
  kable(booktabs = T,
        align = "cccccc",
        caption = "The percentage of stream length within the Upper Walla Walla watershed that falls within optimum, above optimum, above maximum, and above acute temperature thresholds for each species, life stage combination and under recent mean and projected summer stream temperature scenarios.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
temp_suit_tab   
