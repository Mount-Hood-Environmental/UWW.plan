...
Following, we consider each species and life stage, independently, focusing on reaches predicted to exceed optimum, maximum, and acute temperature thresholds under the recent historical and 2040 and 2080 climate warming scenarios. In each, we focused our assessment to the current spatial distribution of the species within the Upper Walla Walla watershed, as provided by StreamNet.
