...
```{r optimum-map, fig.width = 6, fig.height = 7, fig.cap = "Maps depicting whether recent mean (2002-2011) and projected (2040) August mean stream temperatures exceed ('Yes' and 'New Yes') or are below ('No') the top optimal temperature for summer life stages of target species within the Upper Walla Walla watershed. 'New Yes' indicates that the stream length did not exceed optimal temperatures in the previous climate scenario."}
