...
I believe those "within optimum" results are actually real. It's difficult to glean that information from the figures. In each case, the above optimum, above maximum, and above acute increases as addition lower reaches exceed thresholds. However, I wasn't able to map the "within optimum" results with those. I still think that (in some cases) increase in within optimum is a relic of upstream reaches warming to be within optimum ranges at a higher rate than downstream reaches warming to exceed optimum reaches which is somewhat related to the phenomenon that the number of tributaries exceeds the number of "mainstems".
