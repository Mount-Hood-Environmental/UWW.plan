...
<!-- the following inserts MHE logo into header and justifies text throughout -->
...
In nearly every case, a larger percentage of stream length within the Upper Walla Walla Watershed exceeded optimum, maximum, and acute temperature thresholds (Table \@ref(tab:temp-thresh)) when transitioning from recent mean to projected 2040 and 2080 climate warming scenarios (Table \@ref(tab:temp-suit-tab)). The single exception was for Pacific Lamprey where stream temperatures didn't exceed their acute (lethal) temperature threshold of 25^o^C under any scenario. Given recent mean modeled stream temperatures, the percentage of stream length that exceeds optimum temperatures is between 11.5 - 39.5% depending on species and life stage, with Chinook spawning being of most concern. In other words, 39.5% of average modeled August stream temperatures within the Upper Walla Walla watershed are estimated to exceed optimal temperatures for Chinook salmon spawning (5.6 - 14.5^o^) currently. The percentage of stream length that exceeds optimum temperatures increases to 24.9 - 45.6% under the 2040 projected scenario and 33.1 - 48.8% under the 2080 projected scenario. Patterns for the percentage of stream length exceeding maximum temperatures were similar to those observed for optimum temperatures. Using recent mean modeled temperatures, we estimate that only 1.7% of the stream length currently exceeds acute thresholds for Chinook salmon spawning and for bull trout. However, at least for Chinook salmon, steelhead, and bull trout, the percentage of stream length exceeding acute temperatures increases to 1.0 - 6.9% and 3.2 - 14.5% under the projected 2040 and 2080 climate warming scenarios, respectively (Table \@ref(tab:temp-suit-tab)).

Within optimum results...

Not surprisingly, the hypothetical scenario where summer stream temperatures are decreased by 1^o^C relative to the recent mean reduced the percentage of stream length that exceeded optimum, maximum, and acute temperature thresholds for target species and life stages. A reduction of 1^o^C relative to the recent mean scenario resulted in between 5.6 - 10.0% less stream length that exceeded optimum temperatures and 0.9 - 7.5% that exceeded maximum temperatures.
