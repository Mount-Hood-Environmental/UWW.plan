...
chnk_spw_map = merge(rkm, hhs, by = "Reach_ID") %>%
...
```{r chnk-spw-hhs, fig.height = 4, fig.cap = "test"}
chnk_spw_hhs_p = hhs %>%
  filter(scenario == "chnk_spw") %>%
  select(scenario,
         year,
...
chnk_juv_map = merge(rkm, hhs, by = "Reach_ID") %>%
...
```{r chnk-juv-hhs, fig.height = 4, fig.cap = "test"}
chnk_juv_hhs_p = hhs %>%
  filter(scenario == "chnk_juv") %>%
  select(scenario,
         year,
...
sthd_juv_map = merge(rkm, hhs, by = "Reach_ID") %>%
...
```{r sthd-juv-hhs, fig.height = 4, fig.cap = "test"}
sthd_juv_hhs_p = hhs %>%
  filter(scenario == "sthd_juv") %>%
  select(scenario,
         year,
