...
<!--
Here, we summarize the distribution of depth, velocity, and composite suitability values for geomorphic reaches, as box plots. Results are provided for Chinook salmon spawning and Chinook salmon and steelhead juvenile rearing. We focus on results from 2021 to describe the suitability of recent depths and velocities; however, results for 2019 are also provided in the [Supplemental Figures] to show changes resulting from the extensive flooding in 2020.
-->
...
```{r chnk-spw-map, results = 'hide', fig.height = 7, fig.cap = "Map showing the hydraulic habitat suitability for **Chinook salmon spawning** in the Upper Walla Walla watershed for 2019 and 2021, plotted by river kilometer with geomorphic reaches shown."}
