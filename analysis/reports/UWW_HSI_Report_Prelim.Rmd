...
Finally, suitability values were summarized and visualized by year, species, and life stage (Chinook salmon adult spawning, Chinook salmon and steelhead juvenile rearing), and rkm / geomorphic reach. Box plots were used to show the distribution of depth, velocity, and composite suitability values and are provided in the [Results]. Maps showing the HHS, by rkm / geomorphic reach, are provided by species, and life stage, as well as plots showing the HHS for each scenario considered.
