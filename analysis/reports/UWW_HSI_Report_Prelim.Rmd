...
```{r sthd-hsi, fig. height = 3, fig.width = 3, fig.cap = "Suitability indices at varying depths and velocities for juvenile rearing for steelhead from Maret et al. (2006)."}
sthd_hsi = hsi_df %>%
