...
Based on habitat preference information from the South Fork Walla Walla River [@Al-Chokhachy2007], adult (>220mm) and juvenile (<220mm) bull trout prefer low velocity habitat, with depths <0.8m more suitable for juvenile rearing. Hydrualic preferences for both adult and juvenile bull trout align closest with Chinook salmon juvenile suitability curves used in this analysis. As discussed above, of the three species and life stages analyzed, HHS is most limiting for Chinook salmon juvenile rearing, indicating that similar limitations may exist for bull trout in the upper Walla Walla watershed. A literature review of Pacific lamprey habitat preferences did not yield any hydraulic suitability information, prohibiting further discussion on the species.
